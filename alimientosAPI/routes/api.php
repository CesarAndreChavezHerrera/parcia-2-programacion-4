...
Route::get('alimento','App\Http\Controllers\AlimentoController@index');

/* listar un alimento */
Route::get('alimento/{id}','App\Http\Controllers\AlimentoController@show');

/* crear un nuevo registro de alimento */
Route::post('alimento/save','App\Http\Controllers\AlimentoController@store');

/* actualizar el registro de un alimento */
Route::put('alimento/{id}','App\Http\Controllers\AlimentoController@update');
